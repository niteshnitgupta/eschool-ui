      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title"><b>Modify Designation</b></h3>
            ...
            <div class="box-body">
              <div class="form-group">
                <label class="req">Designation <span style="color:#DD0000">*</span></label>
        ...
        <div class="col-md-6">
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"><b>Existing Designations</b></h3>
